...
const initialLoans: Loan[] = [
  ...
  { id: 4, avatar: "/avatars/avatar4.jpg", title: "Payment not going through", updated: "2 days ago", customer: "Christian Bale", customerDate: "24.05.2019", date: "June 08, 2021", time: "5:00 PM", status: "VERIFIED" },
  { id: 5, avatar: "/avatars/avatar5.jpg", title: "Unable to add replies", updated: "2 days ago", customer: "Henry Cavil", customerDate: "24.05.2019", date: "June 08, 2021", time: "4:00 PM", status: "VERIFIED" },
  { id: 6, avatar: "/avatars/avatar6.jpg", title: "Downtime since last week", updated: "3 days ago", customer: "Chris Evans", customerDate: "23.05.2019", date: "June 08, 2021", time: "2:00 PM", status: "VERIFIED" },
...
export default function RecentLoans() {
  ...
  const updateLoanStatus = (id: number, status: "VERIFIED" | "REJECTED") => {
